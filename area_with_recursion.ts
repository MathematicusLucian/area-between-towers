...
function maxArea(height: number[]): number {
    ...
    height.forEach((iHeight, iXAxis) => {
        ...
        compareTowerPairs(iHeight, 0, buildingsAhead, maximumPossibleArea)
...
function compareTowerPairs(iHeight: number, jXAxis: number, buildingsAhead: number[], maximumPossibleArea: number) {

        // First Building in Array
        const buildingJHeight = buildingsAhead[0]
